...
import com.minizone.servicesImplementation.UserServiceImplementation;
...
public class UserController {
	...
	@PostMapping("/addnew")
	public ResponseEntity<String> addUserHandler(@Valid @RequestBody User user) throws UserException{
